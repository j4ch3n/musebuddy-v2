...
export type HandSilhouetteProps = {
  fill?: string;
  hand: 'left' | 'right';
  height: number;
  stroke?: string;
...
export function HandSilhouette({
  ...
  return (
    <Svg accessibilityElementsHidden height={height} viewBox="0 0 100 118" width={width}>
      <G transform="translate(-25 -20) scale(0.145)">
        <Path
          ...
          transform={hand === 'left' ? 'translate(1122 0) scale(-1 1)' : undefined}
        />
      </G>
    </Svg>
  );
