...
import { BarDetails, BarDetailsExit, BarSoundPreviewButton } from '@/components/training-session';
import { Navigator } from '@/components/training-session/legacy/navigator';
