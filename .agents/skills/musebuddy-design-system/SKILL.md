...
- [references/training-layout.md](references/training-layout.md): training shells, navigators,
  learning arenas, control docks, progression, and content grouping.
...
3. Apply the fixed training-screen shell where relevant: compact session navigator, flexible learning arena, and fixed control dock.
...
- the screen has one compact progression row, one large learning arena, and one fixed control dock where it is a training screen;
